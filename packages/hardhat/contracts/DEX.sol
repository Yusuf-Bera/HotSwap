...
contract DEX {
    ...
    // function addMargin(uint256 tokenAmount) public {
    //     require(
    //         token.transferFrom(msg.sender, address(this), tokenAmount),
    //         "transfer failed"
    //     );
    //     marginAccounts[msg.sender] = marginAccounts[msg.sender].add(
    //         tokenAmount
    //     );
    // }

    // function openPosition(uint256 tokenAmount) public {
    //     require(
    //         marginAccounts[msg.sender] >= tokenAmount,
    //         "Not enough collateral"
    //     );
    //     marginAccounts[msg.sender] = marginAccounts[msg.sender].sub(
    //         tokenAmount
    //     );
    //     uint256 leverageAmount = tokenAmount.mul(leverage);
    //     require(token.transfer(msg.sender, leverageAmount), "transfer failed");
    // }

    // function closePosition(uint256 tokenAmount) public {
    //     require(
    //         token.transferFrom(msg.sender, address(this), tokenAmount),
    //         "transfer failed"
    //     );
    //     marginAccounts[msg.sender] = marginAccounts[msg.sender].add(
    //         tokenAmount.div(leverage)
    //     );
    // }
}
